...
const TaskList = ({list, remove, change}) => {
  return (
    <div>
        {list.map((item, index) => (
            <div className='flex justify-between items-center px-5 bg-zinc-800 rounded-xl mb-5 h-11 w-full sm:w-[576px] mx-auto hover:bg-zinc-700 ease-in duration-300' key={item.id}>
